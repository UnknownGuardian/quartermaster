...
async function work() {
  ...
  const before = simulation.eventsPer1000Ticks;
  metronome.setTimeout(() => simulation.eventsPer1000Ticks = 2000, 1000);
  metronome.setTimeout(() => simulation.eventsPer1000Ticks = before, 2000);
  /*metronome.setInterval(() => {
    simulation.eventsPer1000Ticks = Math.sin(metronome.now() / 1000) * 50 + 75
  }, 10);*/
  ...
  const events = await simulation.run(cb, 2500);
